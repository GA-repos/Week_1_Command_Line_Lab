...
2. Create a directory called `galaxy_far_far_away`, and inside the new directory, make a directory named `tatooine` and create the following files in it: `luke.txt`, `ben_kenobi.txt`.
